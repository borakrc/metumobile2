...
class Booklets:
    ...
    def _getBookletData(self):
        return [
    ["survival_turkish.jpg", "1SURVIVAL TURKISH FOR INTERNATIONAL STUDENTS ON CAMPUS","https://intranet.ncc.metu.edu.tr/files/SurvivalTurkish.pdf", "2SURVIVAL TURKISH FOR INTERNATIONAL STUDENTS ON CAMPUS","https://intranet.ncc.metu.edu.tr/files/SurvivalTurkish.pdf"],
