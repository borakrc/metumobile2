...
class Booklets:
    ...
    def _getBookletData(self):
        return [
    ["survival_turkish.jpg", "SURVIVAL TURKISH FOR INTERNATIONAL2 STUDENTS ON CAMPUS","https://intranet.ncc.metu.edu.tr/files/SurvivalTurkish.pdf", "SURVIVAL2 TURKISH FOR INTERNATIONAL STUDENTS ON CAMPUS","https://intranet.ncc.metu.edu.tr/files/SurvivalTurkish.pdf"],
