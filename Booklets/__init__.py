...
class Booklets:
    ...
    def _getBookletData(self):
        return [
    ["survival_turkish.jpg", "SURVIVAL TURKISHH FOR INTERNATIONAL STUDENTS ON CAMPUS","http://intranet.ncc.metu.edu.tr/wp-content/uploads/2018/03/SurvivalTurkish.pdf", "SURVIVAL TURKISHH FOR INTERNATIONAL STUDENTS ON CAMPUS","http://intranet.ncc.metu.edu.tr/wp-content/uploads/2018/03/SurvivalTurkish.pdf"],
