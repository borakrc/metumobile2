...
class Booklets:
    ...
    def _getBookletData(self):
        return [
    ["survival_turkish.jpg", "SURVIVAL TURKISH FOR INTERNATIONAL STUDENTS ON CAMPUS","httpss://intranet.ncc.metu.edu.tr/wp-content/uploads/2018/03/SurvivalTurkish.pdf", "SURVIVAL TURKISH FOR INTERNATIONAL STUDENTS ON CAMPUS","httpss://intranet.ncc.metu.edu.tr/wp-content/uploads/2018/03/SurvivalTurkish.pdf"],
    ["defaultbookletpicture.jpg", "ÇEVRE TELEFON REHBERİ","httpss://intranet.ncc.metu.edu.tr/files/CEVRE_TELEFON_REHBERI_TR.pdf", "PHONE GUIDE","httpss://intranet.ncc.metu.edu.tr/files/CEVRE_TELEFON_REHBERI_ENG.pdf"],
    ...
    ["health.jpg", "MEDİKO","httpss://intranet.ncc.metu.edu.tr/files/mediko-elkitabi.pdf", "MEDICO", "httpss://intranet.ncc.metu.edu.tr/files/medico-healthcare-guide.pdf"],
